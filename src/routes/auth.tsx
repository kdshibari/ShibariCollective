...
function AuthPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Request magic link pointing to the dashboard
    ...
    if (error) {
      ...
      setSubmitted(true);
      toast.success("Secure link dispatched successfully.");
    }
  }
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <motion.div 
          ...
          className="bg-white/40 backdrop-blur-3xl border border-white/60 rounded-[2.5rem] p-8 sm:p-12 shadow-[0_30px_60px_-15px_rgba(78,44,35,0.25)]"
        >
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-sm font-medium text-foreground/70">
              Access the Shibari Collective without passwords.
            </p>
          </div>
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="text-xs uppercase tracking-widest text-foreground/50 mt-4">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center gap-3 rounded-full bg-secondary px-6 py-4 text-sm font-bold uppercase tracking-widest text-secondary-foreground shadow-xl hover:shadow-2xl hover:scale-[1.02] disabled:opacity-50 disabled:hover:scale-100 transition-all"
              >
