        ...
        <AccordionItem value="disclaimer" className="border border-white/10 bg-background/50 rounded-xl px-4">
          ...
          <AccordionContent className="text-xs text-muted-foreground/80 space-y-4 pb-4 leading-relaxed">
            ...
            <ul className="space-y-3 list-disc pl-4">
              <li>
                <strong className="text-foreground/90">Educational Purpose Only:</strong> This website is provided strictly for communication and entertainment purposes. It does not constitute medical, psychological, or relationship advice.
              </li>
              <li>
              ...
              <li>
                <strong className="text-foreground/90">Absolute User Responsibility:</strong> This website does not guarantee or replace active consent. You are exclusively responsible for obtaining and maintaining enthusiastic consent at all times. You are also solely responsible for ensuring all activities comply with your local laws.
              </li>
              <li>
                <strong className="text-foreground/90">Limitation of Liability:</strong> To the maximum extent permitted by law, the creator and developers of Shibari Collective shall not be held liable for any direct, indirect, incidental, or consequential damages arising from your use of this website. This absolute release of liability includes all claims related to personal injury, emotional distress, or relationship disputes.
              </li>
              <li>
